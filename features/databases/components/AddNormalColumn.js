...
export default function AddNormalColumns({ close, colmuns, setColumns }) {

    const [colName, changeColName, colType, changeColType, colDefault, changeColDefault, confirm] = useAddNormalColmun(setColumns);
